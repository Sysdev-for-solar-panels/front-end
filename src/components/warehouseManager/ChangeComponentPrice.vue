...
<template>
    <div class="wrapper">
        <div class="changerBox">
            ...
            <input v-model="id" autocomplete="off" type="text" id="id" placeholder="ID" required><br><br>
            <input v-model="value" autocomplete="off" type="number" id="price" placeholder="Új ár" required><br><br>
